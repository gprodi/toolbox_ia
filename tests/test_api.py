...
sys.path.insert(0, os.path.abspath(os.path.join(os.path.dirname(__file__), '../app_api')))
...
def test_read_main():
    ...
    assert response.json() == {"status": "En ligne", "message": "Bienvenue sur l'API Toolbox 2.0 !"}
